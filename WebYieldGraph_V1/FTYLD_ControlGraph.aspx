<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FTYLD_ControlGraph.aspx.vb" Inherits="WebYieldGraph_V1.FTYLD_ControlGraph" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="auto-style4">
            ...
            <asp:DropDownList ID="DropDownList3" runat="server" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                    <asp:ListItem>Select AUTO</asp:ListItem>
                    <asp:ListItem>FT</asp:ListItem>
                    <asp:ListItem>MAP</asp:ListItem>
             </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="Process">AUTO :</label>&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                    <asp:ListItem>Select AUTO</asp:ListItem>
                    <asp:ListItem>AUTO0</asp:ListItem>
             ...
             <label for="Process">BOX FTB No  :</label>&nbsp;
             <asp:DropDownList ID="DropDownList2" runat="server" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                    <asp:ListItem>Select Box FTB</asp:ListItem>
                    <asp:ListItem>All Box</asp:ListItem>
                    <asp:ListItem>FTB-1</asp:ListItem>
                    <asp:ListItem>FTB-2</asp:ListItem>
                    <asp:ListItem>FTB-3</asp:ListItem>
                    <asp:ListItem>FTB-4</asp:ListItem>
                    <asp:ListItem>FTB-5</asp:ListItem>
                    <asp:ListItem>FTB-6</asp:ListItem>
                    <asp:ListItem>FTB-7</asp:ListItem>
                    <asp:ListItem>FTB-8</asp:ListItem>
                    <asp:ListItem>FTB-9</asp:ListItem>
                    <asp:ListItem>FTB-10</asp:ListItem>
                    <asp:ListItem>FTB-11</asp:ListItem>
                    <asp:ListItem>FTB-12</asp:ListItem>
                    <asp:ListItem>FTB-13</asp:ListItem>
                    <asp:ListItem>FTB-14</asp:ListItem>
                    <asp:ListItem>FTB-15</asp:ListItem>
                    <asp:ListItem>FTB-16</asp:ListItem>
                    <asp:ListItem>FTB-17</asp:ListItem>
                    <asp:ListItem>FTB-18</asp:ListItem>
                    <asp:ListItem>FTB-19</asp:ListItem>
                    <asp:ListItem>FTB-20</asp:ListItem>
                    <asp:ListItem>FTB-21</asp:ListItem>
                    <asp:ListItem>FTB-22</asp:ListItem>
                    <asp:ListItem>FTB-23</asp:ListItem>
                    <asp:ListItem>FTB-24</asp:ListItem>
                    <asp:ListItem>FTB-25</asp:ListItem>
                    <asp:ListItem>FTB-26</asp:ListItem>
                    <asp:ListItem>FTB-27</asp:ListItem>
                    <asp:ListItem>FTB-28</asp:ListItem>
                    <asp:ListItem>FTB-29</asp:ListItem>
                    <asp:ListItem>FTB-30</asp:ListItem>
                    <asp:ListItem>FTB-31</asp:ListItem>
                    <asp:ListItem>FTB-32</asp:ListItem>
                    <asp:ListItem>FTB-33</asp:ListItem>
                    <asp:ListItem>FTB-34</asp:ListItem>
                    <asp:ListItem>FTB-35</asp:ListItem>
                    <asp:ListItem>FTB-36</asp:ListItem>
                    <asp:ListItem>FTB-37</asp:ListItem>
                    <asp:ListItem>FTB-38</asp:ListItem>
                    <asp:ListItem>FTB-39</asp:ListItem>
                    <asp:ListItem>FTB-43</asp:ListItem>
                    <asp:ListItem>FTB-46</asp:ListItem>
                    <asp:ListItem>OSB-1</asp:ListItem>
                    <asp:ListItem>OSB-2</asp:ListItem>
             </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;
             <label for="Process">DEVICE NAME :</label>&nbsp;
             <input id="myInput" type="text" name="DeviceName" placeholder="DeviceName" class="auto-style3">
    </div>
    ...
    <br />
    <div class="auto-style1">
            <table align="center" border="2" style="margin-bottom: 0px" class="auto-style6">
                <tr>
                    <td><strong>Package Name</strong></td>
                    <td class="auto-style5"><strong>Device Name</strong></td>
                    <td><strong>AUTO</strong></td>
                    <td><strong>BOX FTB</strong></td>
                ...
                <tr>
                    ...
                    <td class="auto-style7"> 
                        ...
                        <br />
                        <asp:ImageButton ID="ImageButton2" runat="server" Height="42px" Width="42px" ImageUrl="~/Img/Excel.png" CommandName="ViewSheet"/> 
                        <br />
    ...
    <div class="auto-style1">
            <strong>
            <asp:Label ID="Label10" runat="server" Text="Remark : " style="text-decoration: underline; color: #FF0000"></asp:Label></strong>&nbsp;&nbsp;
            <asp:Image ID="Image4" runat="server" Height="19px" ImageUrl="~/Img/R.jpg" Width="100px" />&nbsp;<strong><asp:Label ID="Label11" runat="server" Text=": UCL"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
            </strong>
            <asp:Image ID="Image5" runat="server" Height="19px" ImageUrl="~/Img/B.jpg" Width="100px" />&nbsp;<strong><asp:Label ID="Label12" runat="server" Text=": LCL"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
            </strong>
            <asp:Image ID="Image6" runat="server" Height="19px" ImageUrl="~/Img/G.jpg" Width="100px" />&nbsp;<strong><asp:Label ID="Label13" runat="server" Text=": Yield"></asp:Label>
            </strong>
    </div>
    <br />
    <div class="auto-style1">
        ...
        <asp:Chart ID="Chart1" runat="server" Width="1000px" RightToLeft="Yes" Height="600px">
            ...
            <Titles>
                <asp:Title Name="Title" Text="FT Process YLD control graph" BackColor="255, 192, 128" Font="Microsoft Sans Serif, 20pt, style=Bold"></asp:Title>
            </Titles>
        </asp:Chart>
    </div>  
            ...
            <tr>
                <td>
                   <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                       GridLines="Vertical" Width="1000px" HorizontalAlign="Center" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
                       ...
                       <Columns>
                           ...
                           <asp:TemplateField HeaderText="Intitial Yield">
                               <ItemTemplate>
                                   <asp:Label id="lblInYield" runat="server"></asp:Label>
                               </ItemTemplate>
                           </asp:TemplateField>
                           ...
                           <asp:TemplateField HeaderText="Pro.Ver">
                               <ItemTemplate>
                    ...
                    <asp:GridView ID="GridView2" runat="server" EmptyDataText="No entries found." AutoGenerateColumns="False" Font-Size="Medium" Width="1000px" ShowHeaderWhenEmpty="True" OnPageIndexChanging="OnPageIndexChanging" PageSize="30" HorizontalAlign="Center" CssClass="auto-style24">
                        <columns>
                            ...
                            <asp:BoundField HeaderText="TotalNGQty" DataField="TotalNGQty" >
                                <HeaderStyle HorizontalAlign="Center" BackColor="#FFCCFF" Font-Size="Smaller" />
                                <ItemStyle BackColor="#FFCCFF" Font-Size="Smaller" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="TotalGoodBin1Qty" DataField="TotalGoodBin1Qty" >
                                <HeaderStyle HorizontalAlign="Center" BackColor="#FFCCFF" Font-Size="Smaller" />
                                <ItemStyle BackColor="#FFCCFF" Font-Size="Smaller" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="TestBoxNo" DataField="ChannelATestBoxNo" >
                                <HeaderStyle HorizontalAlign="Center" BackColor="#FFCCFF" Font-Size="Smaller" />
                                <ItemStyle BackColor="#FFCCFF" Font-Size="Smaller" />
                            </asp:BoundField>
                        </columns>
