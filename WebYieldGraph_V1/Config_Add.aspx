<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Config_Add.aspx.vb" Inherits="WebYieldGraph_V1.Config_Add" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="auto-style4">
            <h2 class="text-center">ADD Data LCL</h2>
        </div>
    </div>
    <div class="panel panel-primary">
        <div class="panel-body">
            ...
            <div class="form-group">
                 ...
                 <asp:TextBox ID="txtLCL" runat="server" class="form-control" ></asp:TextBox>    
            </div>
        ...
        <div class="panel-footer">
            <asp:Button ID="Button1" runat="server"  class="btn btn-primary" Text="ADD" Height="35px"/>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server"  class="btn btn-primary" Text="CLOSE" Height="35px" PostBackUrl="~/Default.aspx"/>
        </div>
    </div>
